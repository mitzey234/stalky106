...
namespace Stalky106
{
	...
	public class UserTranslations
	{
		...
		public Dictionary<RoleType, string> RoleDisplayNames { set; get; } = new Dictionary<RoleType, string>()
		{
			...
			{ RoleType.ChaosConscript, "<color=#03811a>Chaos Conscript</color>" },
			{ RoleType.ChaosMarauder, "<color=#0c7732>Chaos Marauder</color>" },
			{ RoleType.ChaosRepressor, "<color=#045d22>Chaos Repressor</color>" },
			{ RoleType.ChaosRifleman, "<color=#07771a>Chaos Rifleman</color>" },
